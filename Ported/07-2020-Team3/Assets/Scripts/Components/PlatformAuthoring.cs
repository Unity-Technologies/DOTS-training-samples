...
public class PlatformAuthoring : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        conversionSystem.DeclareDependency(gameObject, PlatformCenter);
        ...
        if (!conversionSystem.HasPrimaryEntity(HeadStairsBottom) 
         ...
         || !conversionSystem.HasPrimaryEntity(PlatformCenter) 
        ...
        var platform = new Platform
        {
            ...
            PlatformCenter = conversionSystem.GetPrimaryEntity(PlatformCenter),
