...
public partial class SetLakeAsTargetSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .ForEach((Entity e, int entityInQueryIndex, in Translation translation, in FireFighter fireFighter) =>
            {
                ...
                if (bestDistance < 0.1f)
                {
                    ...
                    ecb.SetComponent(entityInQueryIndex, fireFighter.HeldBucket, new Bucket { Volume = 1f });
