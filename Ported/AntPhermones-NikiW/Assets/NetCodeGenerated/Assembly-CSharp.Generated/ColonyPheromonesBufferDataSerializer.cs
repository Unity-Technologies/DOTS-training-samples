...
{
    [BurstCompile]
    public struct ColonyPheromonesBufferDataGhostComponentSerializer
    {
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<ColonyPheromonesBufferData>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<ColonyPheromonesBufferData>(backupData, 0);
