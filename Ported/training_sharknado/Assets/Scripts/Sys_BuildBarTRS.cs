...
{
    [ BurstCompile ]
    struct UpdateBarTRSJob : IJobForEach< BarPoint1, BarPoint2, BarLength, Translation, Rotation, NonUniformScale >
    {
        public void Execute( [ ReadOnly ] ref BarPoint1 b1, ref BarPoint2 b2, ref BarLength l, ref Translation t, ref Rotation r, ref NonUniformScale s )
        {
