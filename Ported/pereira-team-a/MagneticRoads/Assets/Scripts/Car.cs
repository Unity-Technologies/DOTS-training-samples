...
public class Car
{
    ...
    [Range(0f, 1f)] public float splineTimer;
    ...
    public void Update()
    {
        ...
        if (isInsideIntersection == false)
        {
            ...
            extrudePoint = new Vector2(-RoadGenerator.trackRadius * .5f * splineDirection * splineSide,
                RoadGenerator.trackThickness * .5f * splineSide);
        }
        else
        {
            extrudePoint = new Vector2(-RoadGenerator.trackRadius * .5f * intersectionSide,
        ...
        if (splineTimer >= 1f)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    intersectionSpline.startTangent =
                        Vector3Int.RoundToInt((intersection.position - intersectionSpline.startPoint).normalized);
                    intersectionSpline.endTangent =
                        Vector3Int.RoundToInt((intersection.position - intersectionSpline.endPoint).normalized);
