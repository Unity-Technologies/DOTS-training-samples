...
public class RoadGeneratorSystem : MonoBehaviour
{
...
//        for (int i = 0; i < trackSplines.Count; i++)
//        {
//            var ts = trackSplines[i];
//            var spline = new TrackSplineComponentData
//            {
//                startPoint = ts.startPoint,
//                endPoint = ts.endPoint,
//                anchor1 = ts.anchor1,
//                anchor2 = ts.anchor2,
//                measuredLength = ts.measuredLength,
//                startNormal = new int3(ts.startNormal.x, ts.startNormal.y, ts.startNormal.z),
//                endNormal = new int3(ts.endNormal.x, ts.endNormal.y, ts.endNormal.z),
//                startTangent = new int3(ts.startTangent.x, ts.startTangent.y, ts.startTangent.z),
//                endTangent = new int3(ts.endTangent.x, ts.endTangent.y, ts.endTangent.z)
//            };
//            var entity = entityManager.CreateEntity(typeof(TrackSplineComponentData));
