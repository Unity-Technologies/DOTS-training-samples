...
public class Intersection
{
    ...
    {
        return Matrix4x4.TRS(position, Quaternion.LookRotation(normal),
            new Vector3(RoadGenerator.intersectionSize, RoadGenerator.intersectionSize, RoadGenerator.trackThickness));
    }
}