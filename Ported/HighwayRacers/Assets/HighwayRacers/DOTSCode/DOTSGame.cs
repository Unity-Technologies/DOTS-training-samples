...
namespace HighwayRacers
{
    ...
    public class DOTSGame : MonoBehaviour
    {
        public static DOTSGame instance { get; private set; }
		...
		public void SelectCarAtMousePosition(){
			...
			Car car = DOTSHighway.instance.GetCarAtScreenPosition(Input.mousePosition, carSelectRadius);
			if (car != null) {
				CarView(car);
			} 
		}
		...
		void Start() {
			...
			DOTSHighway.instance.CreateHighway(250);
