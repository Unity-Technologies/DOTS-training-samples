...
namespace Unity.Entities
{
    public sealed unsafe partial class EntityManager
    {
            ...
            ManagedComponentStore srcManagedComponentStore)
        {
            ...
            foreach (var remapChunk in remapChunks)
            {
                Chunk* chunk = remapChunk.chunk;
                Archetype* dstArchetype = remapChunk.dstArchetype;
                EntityComponentStore->ManagedChangesTracker.PatchEntities(dstArchetype, chunk, chunk->Count, entityRemapping, Allocator.Temp);
            }
