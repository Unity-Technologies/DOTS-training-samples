...
public class OverlaySpawnerSystem : ComponentSystem
{
    ...
    {
        RequireSingletonForUpdate<PrefabCollectionComponent>();
    }

    protected override void OnUpdate()
    {
        Entities.WithNone<InitializedOverlaySpawner>().ForEach((Entity entity, ref PrefabCollectionComponent collection) =>
        {
            var prefab = GetSingleton<PrefabCollectionComponent>().OverlayPrefab;
            var colorPrefab = GetSingleton<PrefabCollectionComponent>().OverlayColorPrefab;
