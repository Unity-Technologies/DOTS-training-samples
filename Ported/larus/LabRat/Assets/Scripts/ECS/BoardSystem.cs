...
public class BoardSystem : ComponentSystem
{
    ...
    public void SpawnHomebase(int playerId)
    {
        ...
        var colorsSystem = World.GetExistingSystem<ApplyOverlayColors>();
        var color = colorsSystem.Colors[playerId-1];

        var prefab = GetSingleton<PrefabCollectionComponent>().HomebasePrefab;
