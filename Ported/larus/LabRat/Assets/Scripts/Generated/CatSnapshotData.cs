...
public struct CatSnapshotData : ISnapshotData<CatSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref CatSnapshotData baseline1, ref CatSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref CatSnapshotData baseline, DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref CatSnapshotData baseline, DataStreamReader reader, ref DataStreamReader.Context ctx,
    ...
    public void Interpolate(ref CatSnapshotData target, float factor)
    {
