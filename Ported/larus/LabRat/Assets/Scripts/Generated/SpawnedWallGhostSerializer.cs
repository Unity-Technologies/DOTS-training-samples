...
public struct SpawnedWallGhostSerializer : IGhostSerializer<SpawnedWallSnapshotData>
{
    ...
    public int SnapshotSize => UnsafeUtility.SizeOf<SpawnedWallSnapshotData>();
    ...
    public void CopyToSnapshot(ArchetypeChunk chunk, int ent, uint tick, ref SpawnedWallSnapshotData snapshot, GhostSerializerState serializerState)
    {
        snapshot.tick = tick;
