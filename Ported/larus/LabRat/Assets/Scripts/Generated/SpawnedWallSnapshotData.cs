...
public struct SpawnedWallSnapshotData : ISnapshotData<SpawnedWallSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref SpawnedWallSnapshotData baseline1, ref SpawnedWallSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref SpawnedWallSnapshotData baseline, DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref SpawnedWallSnapshotData baseline, DataStreamReader reader, ref DataStreamReader.Context ctx,
    ...
    public void Interpolate(ref SpawnedWallSnapshotData target, float factor)
    {
