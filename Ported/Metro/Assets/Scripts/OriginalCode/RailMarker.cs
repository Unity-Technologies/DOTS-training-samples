...
public class RailMarker : MonoBehaviour
{
	...
	{
		new Color(255/255.0f, 57/255.0f, 57/255.0f),
		new Color(32/255.0f, 255/255.0f, 131/255.0f),
		new Color(255/255.0f, 186/255.0f, 45/255.0f),
		new Color(35/255.0f, 183/255.0f, 255/255.0f)
	};
	...
	{
		var color = (railMarkerType != RailMarkerType.PLATFORM_START) ?  GetLine_COLOUR_FromIndex(metroLineID) : Color.white;
		Gizmos.color = color;
		GUI.color = color;
