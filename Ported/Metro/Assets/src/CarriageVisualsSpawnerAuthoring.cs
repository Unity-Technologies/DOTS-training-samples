...
public class CarriageVisualsSpawnerAuthoring : MonoBehaviour, IDeclareReferencedPrefabs, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(entity, new CarriageVisualsSpawner {Prefab = conversionSystem.GetPrimaryEntity(TrainPrefab)});
    }
}
