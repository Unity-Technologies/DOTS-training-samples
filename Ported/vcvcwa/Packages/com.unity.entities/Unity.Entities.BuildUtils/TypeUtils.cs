...
namespace Unity.Entities.BuildUtils
{
    public static class TypeUtils
    {
        ...
        internal static void GetFieldOffsetsOfRecurse(Func<FieldDefinition, TypeDefinition, bool> match,
            int offset, TypeDefinition type, List<int> list, int bits)
        {
        ...
        public static List<int> GetFieldOffsetsOf(TypeReference typeToFind, TypeDefinition typeToLookIn, int archBits)
        {
            ...
            {
                GetFieldOffsetsOfRecurse((fieldDef, typeDef) => typeDef.FullName == typeToFind.FullName,
                    0, typeToLookIn, offsets, archBits);
            }
        ...
        /* match: 1st param is the Field, 2nd param is the FieldType */
        public static List<int> GetFieldOffsetsOf(Func<FieldDefinition, TypeDefinition, bool> match, TypeDefinition typeToLookIn, int archBits)
        {
            var offsets = new List<int>();
        ...
        public static List<int> GetFieldOffsetsOf(string fieldTypeName, TypeDefinition typeToLookIn, int archBits)
        {
            var offsets = new List<int>();

            if (typeToLookIn != null)
            {
                GetFieldOffsetsOfRecurse((fieldDef, typeDef) => typeDef.FullName == fieldTypeName, 0, typeToLookIn, offsets, archBits);
            }
        ...
        public static List<int> GetFieldOffsetsOfByFieldName(string fieldName, TypeDefinition typeToLookIn, int archBits)
        {
            ...
            if (typeToLookIn != null)
            {
                GetFieldOffsetsOfRecurse((fieldDef, typeDef) => fieldDef.Name == fieldName, 0, typeToLookIn, offsets, archBits);
            }
