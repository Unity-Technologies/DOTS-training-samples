...
{
    delegate void SystemSelectionCallback(ComponentSystemBase manager, World world);
    ...
    class SystemListView : TreeView
    {
        ...
        readonly Dictionary<ComponentSystemBase, AverageRecorder> recordersByManager = new Dictionary<ComponentSystemBase, AverageRecorder>();
        ...
        HideNode BuildNodesForComponentSystem(ComponentSystemBase manager, ref int currentId)
        {
            switch (manager)
            {
