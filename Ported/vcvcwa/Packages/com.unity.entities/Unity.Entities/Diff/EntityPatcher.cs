...
namespace Unity.Entities
{
    public static unsafe partial class EntityPatcher
    {
        ...
        [BurstCompile]
        struct BuildComponentToEntityMultiHashMap<TComponent> : IJobChunk 
        ...
        [BurstCompile]
        struct BuildComponentToEntityHashMap<TComponent>: IJobChunk 
            where TComponent : struct, IEquatable<TComponent>, IComponentData
        {
            [ReadOnly] public ArchetypeChunkComponentType<TComponent> ComponentType;
            [ReadOnly] public ArchetypeChunkEntityType EntityType;
        ...
        [BurstCompile]
        struct BuildEntityToComponentHashMap<TComponent> : IJobChunk 
            where TComponent : struct, IEquatable<TComponent>, IComponentData
        {
