                ...
                foreach (var assembly in assemblies)
                {
                    ...
                    if (isAssemblyReferencingEntities)
                    {
                        ...
                        foreach (var type in assemblyTypes)
                        {
                            ...
                            // TODO: Remove this once 2019.3.0b9 is available which will allow codegen to 
                            // register these types instead of us searching here
                            if (type.FullName == "Unity.Properties.CodeGeneratedPropertyBagRegistry.PropertyBagRegistry")
                            {
                                var registerFn = type.GetMethod("RegisterAllPropertyBags");
