...
namespace Unity.Entities
{
    ...
    {
        // TODO: placeholder; InterfaceGen needs this tag to find jobs, but JobChunk isn't properly connected as a JobProducer.
        internal struct JobChunkStruct<T> where T : struct, IJobChunk
        {
        }
...
#pragma warning restore
            ...
            where T : struct, IJobChunk
        {
            ...
            var prefilterHandle = ChunkIterationUtility.PreparePrefilteredChunkLists(unfilteredChunkCount,
                query.m_QueryData->MatchingArchetypes, query.m_Filter, dependsOn, mode, out var prefilterData,
