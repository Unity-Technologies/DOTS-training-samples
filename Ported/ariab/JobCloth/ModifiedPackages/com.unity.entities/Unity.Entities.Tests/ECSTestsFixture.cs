...
namespace Unity.Entities.Tests
{
    ...
    public abstract class ECSTestsFixture
    {
...
#if !UNITY_DOTSPLAYER
        // TODO: implement equivalent in DOTS runtime and remove #if !UNITY_DOTSPLAYER from all memory-based tests
        protected Recorder AllocRecorder { get; private set; }
...
#if !UNITY_DOTSPLAYER
            AllocRecorder = Recorder.Get("GC.Alloc");
        ...
        protected int CountGCAllocs(Action action)
        {
            // warm up
            action();
        ...
        protected void ValidateNoGCAllocs(Action action)
        {
