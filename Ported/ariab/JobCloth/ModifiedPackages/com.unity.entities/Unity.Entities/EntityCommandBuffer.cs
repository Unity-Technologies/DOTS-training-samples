...
namespace Unity.Entities
{
    ...
    internal unsafe struct EntityCommandBufferData
    {
        ...
        internal void AddEntityComponentCommand(EntityCommandBufferChain* chain, int jobIndex, ECBCommand op, Entity e, ComponentType componentType)
        {
            Assert.AreEqual(ECBCommand.AddComponent, op);
        ...
        internal void AddEntityComponentCommand<T>(EntityCommandBufferChain* chain, int jobIndex, ECBCommand op, Entity e, T component) where T : struct
        {
            ...
            {
                AddEntityComponentCommand(chain, jobIndex, op, e, ctype);
                return;
            }
    ...
    public unsafe struct EntityCommandBuffer : IDisposable
    {
        ...
        {
            EnforceSingleThreadOwnership();
            m_Data->AddEntityComponentCommand(&m_Data->m_MainThreadChain, MainThreadJobIndex, ECBCommand.AddComponent, e, ComponentType.ReadWrite<T>());
        }

        public void AddComponent(Entity e, ComponentType componentType)
        {
            EnforceSingleThreadOwnership();
            m_Data->AddEntityComponentCommand(&m_Data->m_MainThreadChain, MainThreadJobIndex, ECBCommand.AddComponent, e, componentType);
        }
...
#pragma warning restore 728
        ...
        unsafe public struct Concurrent
        {
            ...
            public void AddComponent<T>(int jobIndex, Entity e) where T : struct, IComponentData
            {
                CheckWriteAccess();
                var chain = ThreadChain;
                m_Data->AddEntityComponentCommand(chain, jobIndex, ECBCommand.AddComponent, e, ComponentType.ReadWrite<T>());
            }
            ...
            public void AddComponent(int jobIndex, Entity e, ComponentType componentType)
            {
                CheckWriteAccess();
                var chain = ThreadChain;
                m_Data->AddEntityComponentCommand(chain, jobIndex, ECBCommand.AddComponent, e, componentType);
            }
