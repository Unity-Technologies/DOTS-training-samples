...
namespace Unity.Entities
{
    ...
    {
        internal unsafe ComponentGroup(EntityGroupData* groupData, ComponentJobSafetyManager* safetyManager, EntityComponentStore* entityComponentStore, ManagedComponentStore managedComponentStore)
        {
