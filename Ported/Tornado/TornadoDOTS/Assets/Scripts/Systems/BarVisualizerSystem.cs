        ...
        Entities
                ...
                in DynamicBuffer<Bar> bars) =>
            {
                for (int c = 0; c < connections.Length; ++c)
                {
                    ...
                    var qzqz2 = 2f * qz * qz;
                    var qzqw2 = 2f * qz * qw;
                    matrix.Value.c0.x = 1 - qyqy2 - qzqz2;
                    matrix.Value.c0.y = qxqy2 + qzqw2;
                    matrix.Value.c0.z = qxqz2 - qyqw2;
                    matrix.Value.c1.x = qxqy2 - qzqw2;
                    matrix.Value.c1.y = 1 - qxqx2 - qzqz2;
                    matrix.Value.c1.z = qyqz2 + qxqw2;
                    matrix.Value.c2.x = qxqz2 + qyqw2;
                    matrix.Value.c2.y = qyqz2 - qxqw2;
                    matrix.Value.c2.z = 1 - qxqx2 - qyqy2;
