...
{
	public class TrackSplineObject
	{
		...
		public TrackSplineObject(Vector3 start, Vector3Int startNewNormal, Vector3 tangent1, Vector3 end, Vector3Int endNewNormal, Vector3 tangent2)
		{
