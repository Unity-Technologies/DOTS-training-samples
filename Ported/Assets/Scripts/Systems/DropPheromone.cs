    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            ...
            .ForEach((Entity antEntity) => {
                ...
                var excitement = (loadout.Value > 0 ? 1f : .1f) * antVelocity.Speed / configuration.AntMaxSpeed;
                var value = UnityMath.math.clamp(pheromone[idx].Value + configuration.TrailAddSpeed * deltaTime * excitement, 0f, 1f);
