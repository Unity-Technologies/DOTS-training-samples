...
public class ClothSimEcsIJobParallelSystem : JobComponentSystem
{
#if UNITY_EDITOR
    ...
    [BurstCompile]
    struct ClothSimVertexIJobParallel : IJobParallelForBatch {
        [ReadOnly]
        ...
        public void Execute(int startIndex, int count) {
            for (int i=startIndex,n=startIndex+count; i<n; ++i)
            {
                ...
                if (v1.y < localY0) {
                    ...
                    float3 oldWorldPos = math.transform(localToWorld, v0);
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
                                         ...
                                         in LocalToWorld localToWorld) =>
        {
            ...
            ClothSimVertexIJobParallel clothSimVertexJob = new ClothSimVertexIJobParallel {
            ...
            combinedJobHandle = JobHandle.CombineDependencies(combinedJobHandle, clothSimVertexJob.ScheduleBatch(vLength,
                                                                                                                 vLength/processorCount,
