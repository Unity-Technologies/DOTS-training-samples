...
readonly partial struct CommuterMovementAspect : IAspect
{
    ...
    readonly RefRW<CommuterSpeed> m_CommuterSpeed;
    ...
    public float3 Speed
    {
        get => m_CommuterSpeed.ValueRO.Value;
        set => m_CommuterSpeed.ValueRW.Value = value;
    }
}