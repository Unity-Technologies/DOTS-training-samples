...
public partial struct FoodSmellBakeInitSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        DFSSmell((int2)food.Center, 200, pheromonesBuffer, globalSettings.MapSizeX, globalSettings.MapSizeY, obstacleBuffer.AsNativeArray(), collisionHashSet);
    }
