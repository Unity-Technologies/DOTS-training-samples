...
public class ObstacleSpawnerSystem : MonoBehaviour
{
    ...
    public void GenerateObstacles()
    {
        ...
        // foreach (Object SpawnerObject in ObstacleSpawnerList)
        {
...
// 
//     public static explicit operator ObstacleSpawner(UnityEngine.Object v)
//     {
...
// public struct ObstacleArcPrimitive : IComponentData
// {
...
public struct ObstacleArcPrimitive
{
    public Vector2 Position;
    public float Radius;
    public float AngleStart;
